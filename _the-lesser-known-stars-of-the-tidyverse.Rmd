...
I'm a big advocate of using and teaching the tidyverse for data analysis and visualization in R (it runs [in the family](http://varianceexplained.org/r/teach-tidyverse/)). In addition to doing these talks, I've released a  course on [Categorical Data in the Tidyverse](https://www..com/courses/categorical-data-in-the-tidyverse). I walk through some of the functions in this course and more from forcats. It's part of the new [Tidyverse Fundamentals skill track](https://www..com/tracks/tidyverse-fundamentals), which is suitable for people are new to R or those looking to switch to the tidyverse. Check it out and let us know what you think. 
